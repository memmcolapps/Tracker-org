...
export function DeviceCard({ device, onViewDetails, onViewLocation, onSettings }: DeviceCardProps) {
      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className={cn("w-12 h-12 rounded-lg flex items-center justify-center", getStatusIcon(device.status))}>
              <Smartphone className="h-6 w-6" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-slate-800">{device.label}</h3>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="text-center">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-sm font-medium text-slate-800">{device.signalStrength}%</span>
              </div>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <div className="flex items-center space-x-2">
              <p className="text-sm font-medium text-slate-800">{device.imei}</p>
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              <span className="text-sm font-medium text-slate-800">{device.networkProvider}</span>
            </div>
          </div>
          <div>
            <p className="text-xs text-slate-500">Location</p>
            <p className="text-sm font-medium text-slate-800">{device.location}</p>
          </div>
        </div>
      </CardContent>
    </Card>
