...
import { User, UserLoginResponse } from "@/types-and-interface/auth.interface";
import {
  createContext,
  useContext,
  useState,
...
interface AuthContextType {
  user: User | null;
  login: (credentials: LoginCredentials) => Promise<UserLoginResponse>;
  logout: () => void;
  loading: boolean;
  ...
  const login = async (
    ...
    try {
      ...
      if (result.success && result.token && result.user) {
        localStorage.setItem("authUserToken", result.token);
